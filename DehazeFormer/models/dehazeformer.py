...
class DEHAZECnnDecoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.conv3 = nn.Conv2d(
            out_channels, 12, kernel_size=3, stride=1, padding=1, bias=False)  # Upsampling factor is 2^2=4, so output channels should be 3*4^2=48
        self.gelu3 = nn.PReLU()
        self.bn3 = nn.BatchNorm2d(12)
        self.pixelshuffle = nn.PixelShuffle(2)  # Upsampling factor is 2
        self.init_weight()
